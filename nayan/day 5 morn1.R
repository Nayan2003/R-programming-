...
sigma = 1  #population standerd deviation
n = 25    #sample size
alpha =0.5
...
# if abs(T)>z_alfa/2, then rejct h_0
# probability of rejection is (counter==1)
...
abline(h = alpha, col ="blue", lwd =2 , lty =2)
text(0.8, 0.09, expression(alpha), cex =1.9)
abline(v = 0.5, lwd =2, lty =2, lty = 2,
       col = "magenta")
points(0.5, 0.63, pchI = 19, cex=2)